...
public class IntroOnboardingPage implements Serializable {
    ...
    public IntroOnboardingPage() {
    }

    public IntroOnboardingPage(String titleText, String descriptionText, int bgColor, int contentIconRes, int bottomBarIconRes) {
    ...
    public boolean equals(Object o) {
        ...
        IntroOnboardingPage that = (IntroOnboardingPage) o;
