...
import com.touchmenotapps.blocks.onboarding.listeners.AnimatorEndListener;
import com.touchmenotapps.blocks.onboarding.listeners.IntroOnboardingOnChangeListener;
import com.touchmenotapps.blocks.onboarding.listeners.IntroOnboardingOnLeftOutListener;
import com.touchmenotapps.blocks.onboarding.listeners.IntroOnboardingOnRightOutListener;
import com.touchmenotapps.blocks.onboarding.listeners.OnSwipeListener;
import com.touchmenotapps.blocks.onboarding.utils.IntroOnboardingEngineDefaults;

import java.util.ArrayList;

public class IntroOnboardingEngine implements IntroOnboardingEngineDefaults {
    ...
    // state variables
    private ArrayList<IntroOnboardingPage> mElements = new ArrayList<>();
     ...
     */
    public IntroOnboardingEngine(View rootLayout, ArrayList<IntroOnboardingPage> contentElements, Context appContext) {
    ...
    protected void initializeStartingState() {
        ...
        for (int i = 0; i < mElements.size(); i++) {
            IntroOnboardingPage IntroOnboardingPage = mElements.get(i);
            ViewGroup bottomBarIconElement = createPagerIconElement(IntroOnboardingPage.getBottomBarIconRes(), i == 0);
            mPagerIconsContainer.addView(bottomBarIconElement);
        }
        // Initialize first element on screen
        IntroOnboardingPage activeElement = getActiveElement();
    ...
    protected void toggleContent(boolean prev) {
        ...
        IntroOnboardingPage newElement = prev ? toggleToPreviousElement() : toggleToNextElement();
    ...
    /**
     * @param IntroOnboardingPage new content page to show
     * @return configured view with new content texts
     */
    protected ViewGroup createContentTextView(IntroOnboardingPage IntroOnboardingPage) {
        LayoutInflater vi = LayoutInflater.from(mAppContext);
        ...
        contentTitle.setText(IntroOnboardingPage.getTitleText());
        TextView contentText = (TextView) contentTextView.getChildAt(1);
        contentText.setText(IntroOnboardingPage.getDescriptionText());
     ...
     */
    protected ImageView createContentIconView(IntroOnboardingPage IntroOnboardingPage) {
        ImageView contentIcon = new ImageView(mAppContext);
        contentIcon.setImageResource(IntroOnboardingPage.getContentIconRes());
        //contentIcon.setColorFilter(Color.argb(255, 255, 255, 255));
     ...
     */
    protected IntroOnboardingPage getActiveElement() {
     ...
     */
    protected IntroOnboardingPage toggleToPreviousElement() {
     ...
     */
    protected IntroOnboardingPage toggleToNextElement() {
